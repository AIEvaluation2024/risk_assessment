...
values,methods = RA_simulation_routines.iid_average(model_type,data_type,num_classes,data_boundary,n,base_file_model,score_type)
filename_error_table = "results/average_values/error_table_" + data_type + "_" + model_type + "_without"   + ".csv"
...
values, methods = RA_simulation_routines.covariate_shift_average(model_type,data_type,num_classes,data_boundary,n,base_file_model,score_type,beta_data)
filename_error_table = "results/average_values/error_table_" + data_type + "_" + model_type + "_with"  + ".csv" 
utils.write_results(values,methods,filename_error_table)
